...
import com.t3.generate.entity.GeneratorParamEntity;
...
public class GenUtils {
	...
	public static List<String> getTemplates() {
		...
		templates.add("template/Dto.java.btl");
		...
		templates.add("template/DaoImpl.java.btl");
		//templates.add("template/Controller.java.btl");
		//templates.add("template/AdminService.java.btl");
		//templates.add("template/AdminServiceImpl.java.btl");
		return templates;
	}
